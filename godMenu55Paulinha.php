...
<div class="container">
		<div class="foto-legenda" > 
			<ul class="fotos botoes">
				<li id="fotoEventos"><a href="setVenue.php"><img width="400" src="images/baladaNova.jpg"></a></li>
				<li id="fotoEventos"><a href="setEvents.php"><img width="400" src="images/eventos.jpg"></a></li>
				<li id="fotoEventos"><a href="list.php"><img width="400" src="images/lista.jpg"></a></li>
				<li id="fotoEventos"><a href="report.php"><img width="400" src="images/novoRelatorios.jpg"></a></li>	
			</ul>		
