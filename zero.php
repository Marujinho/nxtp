<?php
	...
	if(isset($_POST['zeroTab'])){

	$number = $_POST['comanda'];
	$zero = mysqli_query($mysqli, "DELETE FROM booze_sold WHERE tab_number = $number");
	...
	$number = $_POST['comanda'];
	$close = mysqli_query($mysqli, "UPDATE tabs SET entrance = '0' WHERE tab_number = '$number' ");
			...
			<div class="col-md-12">
				<h1>Encontrar comanda</h1>
					...
					<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12">
						<form method="post">	
							<div class="form-group">	
								<label>Zerar tudo:</label>
								<input type="text" name="comanda" placeholder="Numero da comanda" class="form-control">
								<br>
								<input type="submit" name="zeroTab" value="Fechar comanda" class="btn btn-danger">
							</div>			
						</form>
					</div>	
					<br><br>
					<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12">
						<form method="post">	
							<div class="form-group">	
								...
								<input type="text" name="comanda" placeholder="Numero da comanda" class="form-control">
								<br>
								<input type="submit" name="vip" value="Dar vip" class="btn btn-warning">
							</div>			
						</form>
					</div>	
			</div>
